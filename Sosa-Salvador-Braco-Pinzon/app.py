...
def main():
    # Eliminar archivo si existe para evitar errores por duplicados
    file = "db/obras_urbanas.db"
    if os.path.exists(file):
        os.remove(file)

    # Iniciar gestor y conectar base de datos
    ...
    if db:
        ...
        (
            ...
            else gestor.cargar_datos(datos_limpios)
        )
    ...
    obra_nueva_1.iniciar_obra(True, "2024-10-01", "2030-05-31", "Fuente 11", 35)
    ...
    obra_nueva_2.adjudicar_obra("Miavasa SA", "5353333/2024")
    obra_nueva_2.iniciar_obra(True, "2025-01-01", "2035-12-31", "GCBA", 59)
    ...
    indicadores_json = json.dumps(indicadores, indent=2, ensure_ascii=False)
